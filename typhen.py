...
from discord.ext.commands import is_owner, Bot, when_mentioned_or
...
while True:
    ...
    bot = Bot(command_prefix=when_mentioned_or(server_config['prefix']),
              intents=Intents.all(),
    ...
    @bot.command()
    @is_owner()
    async def clear_console(ctx):
        """Clear console"""
        os.system('cls||echo -e \\\\033c')


    @bot.command(aliases=['faint'])
    @is_owner()
